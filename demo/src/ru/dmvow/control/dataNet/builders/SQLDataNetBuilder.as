package ru.dmvow.control.dataNet.builders
{
	...
	public class SQLDataNetBuilder extends DataNetBuilder
	{
		protected static const ITEMS:String = "items";
		protected static const RULES:String = "rules";
		protected var parseType:String;
		protected var fromModel:SQLAssociationModel;
		
		public function createItemsNet(fromModel:SQLAssociationModel):void
		{
		...
		public function createRulesNet(fromModel:SQLAssociationModel):void
		{
			this.fromModel = fromModel;
			parseType = RULES;
			startProcess();
		...
		protected function itemsProcessIteration():void
		{
			var j:Number;
			var k:Number;
			var rule:SQLAssociationRule = fromModel.associationRules[counter];
			var aNode:NetNode;
			var cNode:NetNode;
			var link:NetLink;
